      ...
      <div className="bg-white border border-[#E5E7EB] rounded-2xl p-6 shadow-sm relative overflow-hidden flex flex-col justify-between" id="metric_card_totals">
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="p-2 bg-[#F1F5F9] rounded-xl text-[#0F172A] border border-[#E5E7EB]">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="flex items-baseline gap-1.5 mt-1">
                <span className="text-3xl font-display font-extrabold text-[#0F172A]">{personalCount}</span>
            ...
            <div className="border-l border-[#E5E7EB] pl-4">
              ...
              <div className="flex items-baseline gap-1.5 mt-1">
                <span className="text-3xl font-display font-extrabold text-[#0F172A]">{hubCount}</span>
            ...
            return (
              <div key={stat.value} className="flex flex-col gap-1">
                <div className="flex justify-between text-[11px] font-sans">
                  <span className={hasData ? "text-[#0F172A] font-semibold" : "text-[#94A3B8]"}>
                    {stat.value} - {stat.label.split(':')[0]}
                  </span>
                  <span className={hasData ? "font-mono font-bold text-[#1A1A1A]" : "font-mono text-[#94A3B8]"}>
                    {stat.total}
                  </span>
                </div>
